...
class TrademarkRule extends AbstractRule
{
    ...
    private const ALLOWED_PATTERNS = [
        ...
        '/syncs with/i',
        '/WordPress admin/i',
        '/WordPress dashboard/i',
        '/WordPress site/i',
        '/WordPress installation/i',
        '/WordPress directory/i',
        '/install.*WordPress/i',
        '/activate.*WordPress/i',
        '/a WordPress plugin/i',
        '/WordPress theme/i',
        '/your WordPress/i',
        '/the WordPress (installation|directory|admin|dashboard|site|plugin|theme|core|version|multisite)/i',
        '/in WordPress/i',
        '/on WordPress/i',
        '/from WordPress/i',
        '/to WordPress/i',
